...
public class DefaultCodegen implements CodegenConfig {
    ...
    protected String modelPackage = "", apiPackage = "", interfacePackage = "", fileSuffix;
    protected String modelNamePrefix = "", modelNameSuffix = "";
    protected String testPackage = "";
    protected Map<String, String> apiTemplateFiles = new HashMap<String, String>();
	protected Map<String, String> interfaceTemplateFiles = new HashMap<String, String>();
	...
	public Map<String, String> interfaceTemplateFiles() {
        return interfaceTemplateFiles;
    }
	...
	public String interfaceFileFolder() {
        return outputFolder + "/" + interfacePackage().replace('.', '/');
    }
     ...
     * @return the file name of the Api
     */
    public String toInterfaceFilename(String name) {
        return toInterfaceName(name);
    }
    ...
    public String toInterfaceName(String name) {
        ...
        return "I" + initialCaps(name) + "Controller";
    }
...
*/
	...
	public String interfaceFilename(String templateName, String tag) {
        String suffix = interfaceTemplateFiles().get(templateName);
        return interfaceFileFolder() + File.separator + toInterfaceFilename(tag) + suffix;
    }
