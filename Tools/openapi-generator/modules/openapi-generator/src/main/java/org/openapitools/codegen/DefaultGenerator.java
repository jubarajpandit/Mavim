...
public class DefaultGenerator extends AbstractGenerator implements Generator {
    ...
    private void generateApis(List<File> files, List<Object> allOperations, List<Object> allModels) {
        ...
        for (String tag : paths.keySet()) {
            try {
                ...
                operation.put("interfacePackage", config.interfacePackage());
                ...
                operation.put("interfaceFilename", config.toInterfaceFilename(tag));
                ...
                */
				...
				for (String templateName : config.interfaceTemplateFiles().keySet()) {
                    String filename = config.interfaceFilename(templateName, tag);
                    if (!config.shouldOverwrite(filename) && new File(filename).exists()) {
                        LOGGER.info("Skipped overwriting " + filename);
                        continue;
                    }
    ...
    private Map<String, Object> buildSupportFileBundle(List<Object> allOperations, List<Object> allModels) {
        ...
        bundle.put("interfacePackage", config.interfacePackage());
    ...
    private Map<String, Object> processOperations(CodegenConfig config, String tag, List<CodegenOperation> ops, List<Object> allModels) {
        ...
        operations.put("package", config.interfacePackage());
