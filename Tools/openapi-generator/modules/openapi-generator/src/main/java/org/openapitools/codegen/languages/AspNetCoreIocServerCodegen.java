...
public class AspNetCoreIocServerCodegen extends AbstractCSharpCodegen {
    ...
    protected Logger LOGGER = LoggerFactory.getLogger(AspNetCoreIocServerCodegen.class);

    private boolean useSwashbuckle = true;
    protected int serverPort = 8080;
    protected String serverHost = "0.0.0.0";
    protected String aspnetCoreVersion= "3.0"; // default to 3.0

    public AspNetCoreIocServerCodegen() {
        super();
		...
		interfaceTemplateFiles.put("controllerinterface.mustache", ".cs");
        embeddedTemplateDir = templateDir = "aspnetcoreioc/3.0";
        ...
        addOption(ASPNET_CORE_VERSION,
                "ASP.NET Core version: 3.0 (default), 2.0 (deprecated)",
                aspnetCoreVersion);
    ...
    public void processOpts() {
        ...
        if ("2.0".equals(aspnetCoreVersion)) {
            embeddedTemplateDir = templateDir = "aspnetcoreioc/2.0";
        ...
        } else if ("3.0".equals(aspnetCoreVersion)) {
            // default, do nothing
            LOGGER.info("ASP.NET core version: 3.0");
        } else {
            throw new IllegalArgumentException("aspnetCoreVersion must be '3.0, 2.1', '2.0' but found " + aspnetCoreVersion);
        }
	...
	@Override
    public String interfaceFileFolder() {
        return outputFolder + File.separator + sourceFolder + File.separator + packageName + File.separator + "Interfaces";
    }
