...
public interface CodegenConfig {
	...
	Map<String, String> interfaceTemplateFiles();
    ...
    String toInterfaceFilename(String name);
	...
	String interfaceFilename(String templateName, String tag);
