...
export class StoreService {
  ...
  public deleteOrder(
    ...
    return this.deleteOrderWithHttpInfo(orderId, extraHttpRequestParams).map(
      (response: Response) => {
  ...
  public getInventory(
    ...
    return this.getInventoryWithHttpInfo(extraHttpRequestParams).map(
      (response: Response) => {
        if (response.status === 204) {
          return undefined;
        } else {
  ...
  public getOrderById(
    ...
    return this.getOrderByIdWithHttpInfo(orderId, extraHttpRequestParams).map(
      (response: Response) => {
        if (response.status === 204) {
          return undefined;
        } else {
  ...
  public placeOrder(
    ...
    return this.placeOrderWithHttpInfo(body, extraHttpRequestParams).map(
      (response: Response) => {
        if (response.status === 204) {
          return undefined;
        } else {
