...
export class PetApi {
  ...
  public deletePet(
    ...
    const localVarPath =
      this.basePath +
      "/pet/{petId}".replace("{" + "petId" + "}", String(petId));
    let queryParameters: any = {};
    let headerParams: any = this.extendObj({}, this.defaultHeaders);
    let formParams: any = {};
  ...
  public getPetById(
    petId: number
  ): Promise<{ response: http.ClientResponse; body: Pet }> {
    const localVarPath =
      this.basePath +
      "/pet/{petId}".replace("{" + "petId" + "}", String(petId));
    let queryParameters: any = {};
    ...
    return new Promise<{ response: http.ClientResponse; body: Pet }>(
      (resolve, reject) => {
        request(requestOptions, (error, response, body) => {
          if (error) {
            reject(error);
...
export class StoreApi {
  ...
  public deleteOrder(
    ...
    const localVarPath =
      this.basePath +
      "/store/order/{orderId}".replace("{" + "orderId" + "}", String(orderId));
    let queryParameters: any = {};
    let headerParams: any = this.extendObj({}, this.defaultHeaders);
    let formParams: any = {};
