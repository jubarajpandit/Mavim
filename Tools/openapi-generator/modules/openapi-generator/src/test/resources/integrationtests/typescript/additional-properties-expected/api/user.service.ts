...
export class UserService {
  ...
  public addUser(body?: User, extraHttpRequestParams?: any): Observable<{}> {
    return this.addUserWithHttpInfo(body, extraHttpRequestParams).map(
      (response: Response) => {
  ...
  public updateUser(body?: User, extraHttpRequestParams?: any): Observable<{}> {
    return this.updateUserWithHttpInfo(body, extraHttpRequestParams).map(
      (response: Response) => {
        if (response.status === 204) {
          return undefined;
        } else {
