...
export class ProjectService {
  ...
  public createProject(
    ...
    return this.createProjectWithHttpInfo(
      name,
      address,
      longitude,
      latitude,
  ...
  public deleteProjectById(
    ...
    return this.deleteProjectByIdWithHttpInfo(id, extraHttpRequestParams).map(
      (response: Response) => {
        if (response.status === 204) {
          return undefined;
        } else {
  ...
  public getProjectById(
    ...
    return this.getProjectByIdWithHttpInfo(id, extraHttpRequestParams).map(
      (response: Response) => {
        if (response.status === 204) {
          return undefined;
        } else {
  ...
  public updateProject(
    ...
    return this.updateProjectWithHttpInfo(
      id,
      name,
      address,
      longitude,
   ...
   * @param meta
   */
  public createProjectWithHttpInfo(
    name?: string,
    address?: string,
    longitude?: number,
    latitude?: number,
    ...
    let produces: string[] = ["application/json"];
   ...
   * @param id Project id
   */
  public deleteProjectByIdWithHttpInfo(
    id: number,
    extraHttpRequestParams?: any
  ): Observable<Response> {
   ...
   * @param id Project id
   */
  public getProjectByIdWithHttpInfo(
    id: number,
    extraHttpRequestParams?: any
  ): Observable<Response> {
    const path = this.basePath + `/projects/${id}`;
   ...
   * @param scope Valid with kind as location, and between 1~9
   */
  public getProjectListWithHttpInfo(
    page?: number,
    perPage?: number,
    kind?: string,
    q?: string,
   ...
   * @param thumbnail Project thumbnail
   */
  public updateProjectWithHttpInfo(
    id: number,
    name?: string,
    address?: string,
    longitude?: number,
