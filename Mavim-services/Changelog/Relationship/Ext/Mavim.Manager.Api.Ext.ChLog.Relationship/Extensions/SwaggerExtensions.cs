...
namespace Mavim.Manager.Api.Ext.ChLog.Relationship.Extensions
{
    public static class SwaggerExtensions
    {
        ...
        public static void AddSwaggerGenerator(this IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "ChangelogRelationship Public API", Version = "v1" });
            });
        }
        ...
        public static void UseSwaggerAndSwaggerUi(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ChangelogRelationship Public API v1");
