...
{
    public static class AuthorizationTopicHandlerExtension
    {
        /// <summary>
        /// Adds the authorization topic.
        /// </summary>
        ...
        public static IServiceCollection AddAuthorizationTopic(this IServiceCollection services, IConfiguration configuration, string authorizationApiEndPointKey)
        {
        ...
        public static IApplicationBuilder UseAuthorizationTopic(this IApplicationBuilder app)
        {
            app.UseMiddleware<AuthorizationTopicMiddleware>();
