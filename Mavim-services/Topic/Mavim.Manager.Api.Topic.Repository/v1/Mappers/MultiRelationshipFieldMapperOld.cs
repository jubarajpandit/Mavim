...
{
    internal class MultiRelationshipFieldMapperOld : GenericRelationshipFieldMapper<IMultiValueSimpleField, IMultiRelationshipField>
    {

        public MultiRelationshipFieldMapperOld(IMavimDbDataAccess dataAccess) : base(dataAccess) { }
