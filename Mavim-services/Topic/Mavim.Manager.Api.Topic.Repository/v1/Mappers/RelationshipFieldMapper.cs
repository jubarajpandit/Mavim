...
{
    internal class RelationshipFieldMapper : GenericRelationshipFieldMapper<ISingleValueSimpleField, ISingleRelationshipField>
    {

        public RelationshipFieldMapper(IMavimDbDataAccess dataAccess) : base(dataAccess) { }
