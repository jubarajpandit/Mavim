...
{
    internal class MultiDecimalFieldMapper : GenericDecimalFieldMapper<IBusiness.IMultiDecimalField, IService.IMultiDecimalField>
    {
        protected override IService.IMultiDecimalField GetGenericMappedServiceField(IBusiness.IMultiDecimalField field)
        {
        ...
        protected override IBusiness.IMultiDecimalField GetGenericMappedBusinessField(IService.IMultiDecimalField field)
        {
            return new Business.v1.Models.Fields.MultiDecimalField
            {
                FieldSetId = field.FieldSetId,
                FieldId = field.FieldId,
                SetOrder = field.SetOrder,
