...
{
    internal class RelationshipFieldMapper : GenericRelationshipFieldMapper<IBusiness.ISingleRelationshipField, IService.ISingleRelationshipField>
    {
        protected override IService.ISingleRelationshipField GetGenericMappedServiceField(IBusiness.ISingleRelationshipField field)
        {
        ...
        protected override IBusiness.ISingleRelationshipField GetGenericMappedBusinessField(IService.ISingleRelationshipField field)
        {
            return new Business.v1.Models.Fields.SingleRelationshipField
            {
                FieldId = field.FieldId,
                FieldSetId = field.FieldSetId,
                SetOrder = field.SetOrder,
