...
{
    internal class DateFieldMapper : GenericDateFieldMapper<IBusiness.ISingleDateField, IService.ISingleDateField>
    {
        protected override IService.ISingleDateField GetGenericMappedServiceField(IBusiness.ISingleDateField field)
        {
        ...
        protected override IBusiness.ISingleDateField GetGenericMappedBusinessField(IService.ISingleDateField field)
        {
            return new Business.v1.Models.Fields.SingleDateField
            {
                FieldId = field.FieldId,
                FieldSetId = field.FieldSetId,
                SetOrder = field.SetOrder,
