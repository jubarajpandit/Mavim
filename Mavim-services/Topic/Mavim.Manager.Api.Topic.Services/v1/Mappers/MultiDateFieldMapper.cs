...
{
    internal class MultiDateFieldMapper : GenericDateFieldMapper<IBusiness.IMultiDateField, IService.IMultiDateField>
    {
        protected override IService.IMultiDateField GetGenericMappedServiceField(IBusiness.IMultiDateField field)
        {
        ...
        protected override IBusiness.IMultiDateField GetGenericMappedBusinessField(IService.IMultiDateField field)
        {
            return new Business.v1.Models.Fields.MultiDateField
            {
                FieldSetId = field.FieldSetId,
                FieldId = field.FieldId,
                SetOrder = field.SetOrder,
