...
{
    public class HttpPutMoveLevelUpCommandTest
    {
        ...
        public async Task Execute_ValidArguments_OkObjectResult()
        {
            ...
            mavimDataModelMock.Setup(model => model.Factories.CommandFactory.CreateMoveElementOneLevelUpCommand(It.IsAny<IElement>())).Returns(modelCommandMock.Object);
            ...
            var command = new MoveLevelUpCommand(dataAccessMock.Object, dataLanguage.Object);
