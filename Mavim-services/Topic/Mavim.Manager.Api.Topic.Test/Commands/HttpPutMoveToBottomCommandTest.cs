...
{
    public class HttpPutMoveToBottomCommandTest
    {
        ...
        public async Task Execute_ValidArguments_OkObjectResult()
        {
            ...
            mavimDataModelMock.Setup(model => model.Factories.CommandFactory.CreateMoveElementToLastPositionInBranchCommand(It.IsAny<IElement>())).Returns(modelCommandMock.Object);
            ...
            var command = new MoveToBottomCommand(dataAccessMock.Object, dataLanguage.Object);
