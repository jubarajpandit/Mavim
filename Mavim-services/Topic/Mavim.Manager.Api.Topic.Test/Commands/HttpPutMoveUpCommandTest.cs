...
{
    public class HttpPutMoveUpCommandTest
    {
        ...
        public async Task Execute_ValidArguments_OkObjectResult()
        {
            ...
            mavimDataModelMock.Setup(model => model.Factories.CommandFactory.CreateMoveElementOnePositionUpInBranchCommand(It.IsAny<IElement>())).Returns(modelCommandMock.Object);
            ...
            var command = new MoveUpCommand(dataAccessMock.Object, dataLanguage.Object);
