...
namespace Mavim.Manager.Api.Topic.Test.Commands
{
    public class QueryRetrieveTopicTypesCommandTest
    {
        ...
        public async Task Execute_ValidArguments_OkObjectResult()
        {
            ...
            mavimDataModelMock.Setup(model => model.Factories.CommandFactory.CreateMoveElementOnePositionDownInBranchCommand(It.IsAny<IElement>())).Returns(modelCommandMock.Object);
            ...
            var command = new MoveDownCommand(dataAccessMock.Object, dataLanguage.Object);
