...
{
    public class HttpPutMoveLevelDownCommandTest
    {
        ...
        public async Task Execute_ValidArguments_OkObjectResult()
        {
            ...
            mavimDataModelMock.Setup(model => model.Factories.CommandFactory.CreateMoveElementOneLevelDownCommand(It.IsAny<IElement>())).Returns(modelCommandMock.Object);
            ...
            var command = new MoveLevelDownCommand(dataAccessMock.Object, dataLanguage.Object);
