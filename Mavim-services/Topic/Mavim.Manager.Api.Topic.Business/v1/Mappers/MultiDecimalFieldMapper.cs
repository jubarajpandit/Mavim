...
{
    internal class MultiDecimalFieldMapper : GenericDecimalFieldMapper<IRepo.IMultiDecimalField, IBusiness.IMultiDecimalField>
    {
        protected override IBusiness.IMultiDecimalField GetGenericMappedBusinessField(IRepo.IMultiDecimalField field)
        {
        ...
        protected override IRepo.IMultiDecimalField GetGenericMappedRepoField(IBusiness.IMultiDecimalField field)
        {
            return new Repository.v1.Fields.MultiDecimalField
            {
                FieldSetId = field.FieldSetId,
                FieldId = field.FieldId,
                SetOrder = field.SetOrder,
