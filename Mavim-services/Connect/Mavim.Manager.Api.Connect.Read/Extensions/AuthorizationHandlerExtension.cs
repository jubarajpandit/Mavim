...
namespace Mavim.Manager.Api.Connect.Read.Extensions
{
    ...
    {
        private const string ApplicationId = "Mavim:ConnectReadSettings:ApplicationId";
        private const string ApplicationIdInternal = "Mavim:ConnectReadSettings:ApplicationIdInternal";
        private const string TenantId = "Mavim:ConnectReadSettings:TenantId";
