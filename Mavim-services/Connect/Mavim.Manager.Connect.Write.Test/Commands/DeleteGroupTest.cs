...
namespace Mavim.Manager.Connect.Write.Test.Commands
{
    ...
    {
        [Fact]
        [Trait("Category", "Connect DeleteGroupCommand Write")]
        public async Task DeleteGroup_ValidArguments_ValidModelStateAsync()
        {
            ...
            var handler = new DeleteGroup.Handler(eventSourcing.Object, identity, serviceBus.Object);
            var command = new DeleteGroup.Command(identity.GroupId);
        ...
        [Fact]
        [Trait("Category", "Connect DeleteGroupCommand Write")]
        public async Task DeleteGroup_InvalidEventSourcingGenericDependencyInjection_ArgumentNullException()
        {
            // Arrange
            ...
            // Act
            Exception exception = await Record.ExceptionAsync(() => new DeleteGroup.Handler(eventSourcing, identity, serviceBus.Object)?.Handle(null, cancellationToken));
        ...
        [Fact]
        [Trait("Category", "Connect DeleteGroupCommand Write")]
        public async Task DeleteGroup_InvalidIdentityDependencyInjection_ArgumentNullException()
        {
            // Arrange
        ...
        [Fact]
        [Trait("Category", "Connect DeleteGroupCommand Write")]
        public async Task DeleteGroup_InvalidCommandParameter_ArgumentNullException()
        {
            // Arrange
            var eventSourcing = new GroupV1EventSourcing(new Database.ConnectDbContext());
        ...
        [Fact]
        [Trait("Category", "Connect DeleteGroupCommand Write")]
        public async Task DeleteGroup_DatabaseFailed_Exception()
        {
            // Arrange
            var eventSourcing = new Mock<IEventSourcingGeneric<GroupV1>>();
