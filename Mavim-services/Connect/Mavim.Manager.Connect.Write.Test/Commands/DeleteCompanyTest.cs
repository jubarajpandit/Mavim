...
namespace Mavim.Manager.Connect.Write.Test.Commands
{
    ...
    {
        [Fact]
        [Trait("Category", "Connect DeleteCompanyCommand Write")]
        public async Task DeleteCompany_ValidArguments_ValidModelStateAsync()
        {
            // Arrange
            ...
            eventSourcing.Setup(es => es.PlayEvents(It.IsAny<IReadOnlyList<EventSourcingModel>>()))
                .ReturnsAsync(() => new CompanyV1() { IsActive = true });
            ...
            var handler = new DeleteCompany.Handler(eventSourcing.Object, identity, serviceBus.Object);
            var command = new DeleteCompany.Command(identity.CompanyId);
        ...
        [Fact]
        [Trait("Category", "Connect DeleteCompanyCommand Write")]
        public async Task DeleteCompany_InvalidEventSourcingGenericDependencyInjection_ArgumentNullException()
        {
            // Arrange
            ...
            // Act
            Exception exception = await Record.ExceptionAsync(() => new DeleteCompany.Handler(eventSourcing, identity, serviceBus.Object)?.Handle(null, cancellationToken));
        ...
        [Fact]
        [Trait("Category", "Connect DeleteCompanyCommand Write")]
        public async Task DeleteCompany_InvalidIdentityDependencyInjection_ArgumentNullException()
        {
            // Arrange
            var eventSourcing = new CompanyV1EventSourcing(new Database.ConnectDbContext());
        ...
        [Fact]
        [Trait("Category", "Connect DeleteCompanyCommand Write")]
        public async Task DeleteCompany_InvalidCommandParameter_ArgumentNullException()
        {
            // Arrange
            var eventSourcing = new CompanyV1EventSourcing(new Database.ConnectDbContext());
        ...
        [Fact]
        [Trait("Category", "Connect DeleteCompanyCommand Write")]
        public async Task DeleteCompany_DatabaseFailed_Exception()
        {
            // Arrange
            var eventSourcing = new Mock<IEventSourcingGeneric<CompanyV1>>();
