...
import { addScreenshot } from "../src/support/lib/context";
...
export const hooksConfig = {
   ...
   * @param {Array.<String>} specs List of spec file paths that are to be run
   */
  before(capabilitiesv: unknown, specs: unknown): void {
    const width: string = process.env.SCREEN_WIDTH ?? "";
    const height: string = process.env.SCREEN_HEIGHT ?? "";
    browser.setWindowSize(parseInt(width, 10), parseInt(height, 10));
  },
  /**
